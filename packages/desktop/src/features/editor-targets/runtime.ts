...
/** Check Windows execution aliases that reject an ordinary stat lookup */
...
/** Limit the access fallback to executable aliases in WindowsApps */
...
/** Resolve ordinary files and accessible WindowsApps execution aliases */
