...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      platform: "darwin",
      execPath: "/Applications/Paseo Reforged.app/Contents/MacOS/Paseo Reforged",
      resourcesPath: "/Applications/Paseo Reforged.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/Paseo Reforged.app/Contents/Frameworks/Paseo Reforged Helper.app/Contents/MacOS/Paseo Reforged Helper",
    );
  });
});
