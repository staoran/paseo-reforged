...
const CATALOG_DATA = [
  ...
  },
  {
    ...
    command: ["npx", "-y", "cline@3.0.60", "--acp"],
  },
  {
    id: "codebuddy-code",
  ...
  },
  {
    ...
    command: ["npx", "-y", "deepagents-acp@0.1.28"],
  },
  {
    id: "devin",
    title: "Devin CLI",
  ...
  },
  {
    ...
    command: ["npx", "-y", "dimcode@0.3.22", "acp"],
  },
  {
    id: "dirac",
    title: "Dirac",
    ...
    command: ["npx", "-y", "dirac-cli@0.5.1", "--acp"],
  },
  {
    id: "factory-droid",
    title: "Factory Droid",
    ...
    command: ["npx", "-y", "droid@0.208.0", "exec", "--output-format", "acp-daemon"],
    env: {
  ...
  },
  {
    ...
    command: ["uvx", "--from", "fast-agent-acp==0.10.13", "fast-agent-acp", "-x"],
  },
  {
    id: "gemini",
    title: "Gemini CLI",
    ...
    command: ["npx", "-y", "@google/gemini-cli@0.57.0", "--acp"],
  },
  {
    id: "glm-acp-agent",
    title: "GLM Agent",
    ...
    command: ["npx", "-y", "glm-acp-agent@1.7.0"],
  },
  {
    id: "goose",
    title: "goose",
  ...
  },
  {
    ...
    command: ["npx", "-y", "@qoder-ai/qodercli@1.1.34", "--acp"],
  },
  {
    id: "qwen-code",
    title: "Qwen Code",
    ...
    command: ["npx", "-y", "@qwen-code/qwen-code@0.22.3", "--acp", "--experimental-skills"],
  },
  {
    id: "sigit",
    title: "siGit Code",
