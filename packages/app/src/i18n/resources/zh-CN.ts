...
export const zhCN: TranslationResources = {
  ...
  sessions: {
    ...
    searchRequiresUpgrade: "历史搜索需要较新版本的 Paseo daemon",
  ...
  message: {
    ...
    actions: {
      ...
      fitMermaidDiagram: "适应窗口",
      panMermaidDiagram: "拖动图表",
      resetMermaidDiagram: "重置缩放",
      selectMermaidText: "选择文字",
      zoomInMermaidDiagram: "放大",
      zoomOutMermaidDiagram: "缩小",
  ...
  settings: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        systemDefault: "系统默认",
        interfaceFont: "界面字体",
        interfaceFontHint: "用于导航、控件和标签。留空则使用系统默认",
        interfaceFontAccessibility: "界面字体族",
        interfaceSize: "界面字号",
        interfaceSizeAccessibility: "界面字号",
        workspaceFont: "工作区字体",
        workspaceFontHint: "用于消息、Markdown 和输入区。留空则使用系统默认",
        workspaceFontAccessibility: "工作区字体族",
        workspaceSize: "工作区字号",
        workspaceSizeAccessibility: "工作区字号",
        codeFont: "代码字体",
