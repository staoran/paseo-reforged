...
export const ru: TranslationResources = {
  ...
  sessions: {
    ...
    searchRequiresUpgrade: "Для поиска по истории требуется более новая версия демона Paseo",
  ...
  message: {
    editLastUserMessage: {
      action: "Изменить сообщение",
      input: "Изменить сообщение",
      cancel: "Отменить изменение",
      submit: "Отправить изменение",
      unchanged: "Диалог не изменился. Черновик правки сохранён.",
      rewound: "Диалог был откачен, но изменённое сообщение не отправлено.",
      unknown:
        "Не удалось подтвердить состояние диалога. Правка восстановлена на время обновления истории.",
      resyncFailed: "Не удалось обновить историю диалога. Отправка остаётся отключённой.",
    },
    diagram: {
      diagram: "Диаграмма",
    ...
    actions: {
      ...
      fitMermaidDiagram: "Вписать в область",
      panMermaidDiagram: "Перетаскивать диаграмму",
      resetMermaidDiagram: "Сбросить масштаб",
      selectMermaidText: "Выбирать текст",
      zoomInMermaidDiagram: "Увеличить",
      zoomOutMermaidDiagram: "Уменьшить",
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        agentRuntimeCloseFailed: "Не удалось остановить runtime агента: {{message}}",
        agentRuntimeCleanupWarning:
          "Вкладка агента закрыта, но очистка runtime завершилась с предупреждением: {{message}}",
        updateHostToCloseAgentRuntime:
          "Обновите хост, чтобы останавливать runtime агента при закрытии вкладок.",
      ...
      confirmations: {
        ...
        close: "Закрыть",
        cancel: "Отмена",
        stopAgent: "Остановить и закрыть",
        ...
        stopRunningAgentTitle: "Остановить работающего агента?",
        stopRunningAgentMessage:
          "Этот агент все еще работает. Остановка runtime закроет вкладку, но сеанс останется доступным.",
        ...
        bulk: {
          all: "Будут остановлены {{agents}} runtime агента и закрыты их вкладки, а также закрыты {{terminals}} терминала и {{tabs}} другие вкладки. Сеансы агентов останутся доступными. Любой запущенный процесс в закрытом терминале будет немедленно остановлен.",
          agentsAndTerminals:
            "Будут остановлены {{agents}} runtime агента и закрыты их вкладки, а также закрыты {{terminals}} терминала. Сеансы агентов останутся доступными. Любой запущенный процесс в закрытом терминале будет немедленно остановлен.",
          terminalsAndTabs:
          ...
          agentsAndTabs:
            "Будут остановлены {{agents}} runtime агента и закрыты их вкладки, а также {{tabs}} другие вкладки. Сеансы агентов останутся доступными.",
          terminals:
          ...
          agents:
            "Будут остановлены {{agents}} runtime агента и закрыты их вкладки. Сеансы останутся доступными.",
        },
      },
    },
    header: {
  ...
  sidebar: {
    ...
    project: {
      ...
      confirmations: {
        ...
        removeMessage:
          "Удалить проект «{{name}}» с боковой панели?\n\nФайлы на диске не будут изменены.",
  ...
  desktop: {
    ...
    permissions: {
      ...
      testNotification: {
        title: "Тест уведомлений Paseo Reforged",
  ...
  rootError: {
    ...
    title: "В Paseo Reforged возникла проблема.",
    ...
    copySuccess: "Сведения скопированы.",
    copyFailed: "Не удалось скопировать сведения. Выделите и скопируйте текст вручную.",
  },
  startup: {
  ...
  onboarding: {
    title: "Добро пожаловать в Paseo Reforged",
  ...
  pairing: {
    ...
    device: {
      ...
      copied: "Скопировано",
      transport: {
        title: "Передача через реле",
        description: "Настройки данных реле со сквозным шифрованием.",
        encoding: {
          label: "Формат зашифрованных данных",
          newConnections: "Применяется к новым подключениям через реле.",
          auto: "Авто",
          base64: "Base64",
          binary: "Двоичный",
        },
        compression: {
          label: "Сжатие синхронизации",
          description:
            "Сразу применяется к подходящим данным синхронизации, отправка которых ещё не началась. Интерактивный трафик в реальном времени не сжимается.",
          accessibilityLabel: "Включить сжатие синхронизации",
        },
      },
    },
  },
  ...
  contextWindow: {
    ...
    inputTokens: "Входные токены {{count}}",
    cachedInputTokens: "Кэшированные входные токены {{count}}",
    outputTokens: "Выходные токены {{count}}",
    sessionCost: "Стоимость сеанса{{cost}}",
    accessibility: "Контекстное окно{{percentage}}% использовано",
    accessibilityUsage: "Использование сеанса доступно",
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    general: {
      ...
      autoExpandActivity: {
        label: "Оставлять весь процесс хода развёрнутым",
        description:
          "После завершения хода оставлять видимыми ход работы, рассуждения, вызовы инструментов и планы",
      },
      autoExpandReasoning: {
        label: "Разворачивать рассуждения и инструменты",
        description:
          "По умолчанию разворачивать блоки рассуждений, группы вызовов инструментов и их детали",
      },
      toolCallDetail: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        interfaceFontHint:
          "Используется для навигации, элементов управления и меток. Оставьте пустым для системного значения по умолчанию",
        ...
        workspaceFont: "Шрифт рабочей области",
        workspaceFontHint:
          "Используется в сообщениях, Markdown и области ввода. Оставьте пустым для системного значения по умолчанию",
        workspaceFontAccessibility: "Семейство шрифтов рабочей области",
        workspaceSize: "Размер рабочей области",
        workspaceSizeAccessibility: "Размер шрифта рабочей области",
        codeFont: "Шрифт кода",
        codeFontHint:
    ...
    host: {
      ...
      skills: {
        ...
        removeMessage:
          "{{name}} будут удалены из ~/.agents, ~/.claude и ~/.codex на этом хосте. Всё, что вы добавили в эти папки навыков, тоже будет удалено.",
      ...
      daemon: {
        ...
        update: {
          desktopManagedHint:
            "Этот демон управляется Paseo Reforged Desktop. Обновите Paseo Reforged Desktop на хосте.",
