...
export const es: TranslationResources = {
  ...
  agentPanel: {
    states: {
      ...
      cachedHistoryMayBeOutdated: "El historial local en caché puede no estar actualizado.",
      startAgent: "Iniciar agente",
      startingAgent: "Iniciando agente...",
      startAgentFailed: "No se pudo iniciar el agente: {{message}}",
  ...
  sessions: {
    ...
    searchRequiresUpgrade: "La búsqueda del historial requiere un daemon de Paseo más reciente",
  ...
  message: {
    ...
    actions: {
      ...
      fitMermaidDiagram: "Ajustar a la vista",
      panMermaidDiagram: "Arrastrar diagrama",
      resetMermaidDiagram: "Restablecer zoom",
      selectMermaidText: "Seleccionar texto",
      zoomInMermaidDiagram: "Acercar",
      zoomOutMermaidDiagram: "Alejar",
      hideMermaidSource: "Ocultar código fuente de Mermaid",
      showMermaidSource: "Mostrar código fuente de Mermaid",
  ...
  sidebar: {
    ...
    workspace: {
      activity: {
        justNow: "ahora mismo",
        minuteAgo: "hace {{value}} min",
        hourAgo: "hace {{value}} h",
        dayAgo: "hace {{value}} d",
        weekAgo: "hace {{value}} sem",
      },
      status: {
  ...
  contextWindow: {
    ...
    inputTokens: "Fichas de entrada {{count}}",
    cachedInputTokens: "Fichas de entrada en caché {{count}}",
    outputTokens: "Fichas de salida {{count}}",
    sessionCost: "Costo de la sesión{{cost}}",
    accessibility: "Ventana de contexto{{percentage}}% utilizada",
    accessibilityUsage: "Uso de sesión disponible",
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    general: {
      ...
      lazyLoadAgents: {
        label: "Cargar agentes de forma diferida",
        description:
          "Muestra el historial local de los agentes cerrados hasta que inicies uno o envíes un mensaje",
        accessibilityLabel: "Cargar agentes de forma diferida",
      },
      terminalScrollback: {
