...
export const ko: TranslationResources = {
  ...
  message: {
    editLastUserMessage: {
      ...
      cancel: "편집 취소",
      submit: "편집 제출",
      unchanged: "메시지가 변경되지 않았습니다. 편집 내용은 그대로 유지됩니다.",
      rewound: "대화는 되감았지만 편집한 메시지는 전송되지 않았습니다.",
      unknown:
        "대화 상태를 확인할 수 없습니다. 기록을 새로 고치는 동안 편집 내용이 복원되었습니다.",
      resyncFailed: "대화 기록을 새로 고칠 수 없습니다. 메시지 전송은 계속 비활성화됩니다.",
    },
    diagram: {
      diagram: "다이어그램",
      zoomIn: "확대",
    ...
    actions: {
      copyCode: "코드 복사",
      copyMermaidSource: "Mermaid 소스 복사",
      expandMermaidDiagram: "Mermaid 다이어그램 확대",
      fitMermaidDiagram: "화면에 맞추기",
      panMermaidDiagram: "다이어그램 이동",
      resetMermaidDiagram: "확대/축소 재설정",
      selectMermaidText: "텍스트 선택",
      zoomInMermaidDiagram: "확대",
      zoomOutMermaidDiagram: "축소",
      hideMermaidSource: "Mermaid 소스 숨기기",
    ...
    activity: {
      details: "세부 정보",
      completed: "작업 완료",
      completedWithDuration: "{{duration}} 동안 작업함",
    },
    dictation: {
      start: "음성 받아쓰기 시작",
      cancel: "받아쓰기 취소",
  ...
  workspace: {
    ...
    tabs: {
      ...
      toasts: {
        ...
        agentRuntimeCloseFailed: "에이전트 런타임을 중지할 수 없습니다: {{message}}",
        agentRuntimeCleanupWarning:
          "에이전트 탭은 닫혔지만 런타임 정리 중 문제가 보고되었습니다: {{message}}",
        updateHostToCloseAgentRuntime:
          "탭을 닫을 때 에이전트 런타임을 중지하려면 호스트를 업데이트하세요.",
      ...
      confirmations: {
        ...
        stopRunningAgentTitle: "실행 중인 에이전트를 중지할까요?",
        stopRunningAgentMessage:
          "이 에이전트는 아직 실행 중입니다. 런타임을 중지하면 탭은 닫히지만 세션은 계속 사용할 수 있습니다.",
  ...
  settings: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        workspaceFont: "워크스페이스 글꼴",
        workspaceFontHint:
          "메시지, Markdown, 작성기에 사용됩니다. 시스템 기본값을 사용하려면 비워 두세요",
        workspaceFontAccessibility: "워크스페이스 글꼴 패밀리",
        workspaceSize: "워크스페이스 크기",
        workspaceSizeAccessibility: "워크스페이스 글꼴 크기",
        codeFont: "코드 글꼴",
        codeFontHint:
