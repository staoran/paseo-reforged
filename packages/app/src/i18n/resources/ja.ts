...
export const ja: TranslationResources = {
  ...
  message: {
    ...
    actions: {
      ...
      fitMermaidDiagram: "表示領域に合わせる",
      panMermaidDiagram: "図をドラッグ",
      resetMermaidDiagram: "ズームをリセット",
      selectMermaidText: "テキストを選択",
      zoomInMermaidDiagram: "拡大",
      zoomOutMermaidDiagram: "縮小",
