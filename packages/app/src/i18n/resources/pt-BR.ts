...
export const ptBR: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Paseo Reforged",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Paseo Reforged inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Paseo Reforged não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Paseo Reforged não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do Paseo Reforged",
      },
      logs: {
    ...
    rosetta: {
      ...
      runningIntel:
        "Você está executando a build Intel do Paseo Reforged pelo Rosetta no Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Paseo Reforged.",
      },
    },
  },
  rootError: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Paseo Reforged.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do Paseo Reforged funciona",
      ...
      updateRequired: "Atualize o host para ativar o relay pelo Paseo Reforged Desktop.",
      unavailable: "Oferta de pareamento indisponível.",
      hint: "Escaneie este QR code com o Paseo Reforged no seu celular ou copie o link abaixo.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o Paseo Reforged {{count}} vez",
      other: "chamou o Paseo Reforged {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "O Paseo Reforged entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo Paseo Reforged para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O Paseo Reforged escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o Paseo Reforged usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o Paseo Reforged usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no Paseo Reforged.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o Paseo Reforged neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Paseo Reforged skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Paseo Reforged skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Paseo Reforged de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Paseo Reforged",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Paseo Reforged",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Paseo Reforged reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Paseo Reforged reconecta automaticamente. Tente novamente quando o host aparecer como online.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O Paseo Reforged supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Paseo Reforged usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
