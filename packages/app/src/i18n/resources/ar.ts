...
export const ar: TranslationResources = {
  ...
  message: {
    ...
    actions: {
      ...
      fitMermaidDiagram: "ملاءمة للعرض",
      panMermaidDiagram: "سحب المخطط",
      resetMermaidDiagram: "إعادة ضبط التكبير",
      selectMermaidText: "تحديد النص",
      zoomInMermaidDiagram: "تكبير",
      zoomOutMermaidDiagram: "تصغير",
  ...
  contextWindow: {
    ...
    inputTokens: "رموز الإدخال {{count}}",
    cachedInputTokens: "رموز الإدخال المخزنة مؤقتًا {{count}}",
    outputTokens: "رموز الإخراج {{count}}",
    sessionCost: "تكلفة الجلسة{{cost}}",
    accessibility: "تم استخدام نافذة السياق{{percentage}}%",
    accessibilityUsage: "استخدام الجلسة متاح",
  },
  review: {
    comment: {
  ...
  settings: {
    ...
    general: {
      ...
      autoExpandActivity: {
        label: "إبقاء عملية الجولة كاملة موسعة",
        description: "بعد اكتمال الجولة، إبقاء نص العملية والاستدلال واستدعاءات الأدوات والخطط ظاهرة",
      },
      autoExpandReasoning: {
        label: "توسيع تفاصيل الاستدلال والأدوات افتراضيًا",
        description: "توسيع كتل الاستدلال ومجموعات استدعاءات الأدوات وتفاصيلها افتراضيًا",
      },
      toolCallDetail: {
