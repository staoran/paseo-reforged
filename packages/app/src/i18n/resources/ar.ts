...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Paseo Reforged",
  ...
  desktop: {
    ...
    quitting: {
      title: "جارٍ إنهاء Paseo Reforged...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Paseo Reforged ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Paseo Reforged من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء Paseo Reforged",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Paseo Reforged ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار Paseo Reforged",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت Paseo ReforgedCLI.",
      },
    },
  },
  rootError: {
  ...
  onboarding: {
    title: "مرحبا بكم في Paseo Reforged",
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم Paseo Reforged.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم Paseo Reforged يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع Paseo Reforged",
      ...
      updateRequired: "حدّث المضيف لتمكين التتابع من Paseo Reforged Desktop.",
      unavailable: "عرض الاقتران غير متاح.",
      hint: "قم بمسح رمز QR هذا باستخدام Paseo Reforged على هاتفك، أو انسخ الرابط أدناه.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى Paseo Reforged {{count}} مرة",
      other: "استدعى Paseo Reforged {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "سلّم Paseo Reforged الإشعار إلى نظام التشغيل.",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه Paseo Reforged لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار Paseo Reforged نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه Paseo Reforged",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم Paseo Reforged نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر Paseo Reforged.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Paseo Reforged على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Paseo Reforged ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Paseo Reforged ؟",
        uninstallMessage:
          "يزيل جميع مهارات تنسيق Paseo Reforged من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "تمكين أدوات Paseo Reforged",
          hint: "سيتمكن الوكلاء من إدارة أشجار العمل والوكلاء والجداول الزمنية",
          accessibilityLabel: "حقن أدوات Paseo Reforged",
        },
        systemPrompt: {
          title: "موجه النظام",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Paseo Reforged بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Paseo Reforged بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير Paseo Reforged Desktop هذا البرنامج الخفي. حدّث Paseo Reforged Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف Paseo Reforged على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Paseo Reforged لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
