export const en = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Paseo Reforged worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Paseo Reforged start and stop the built-in daemon",
      ...
      keepRunning: {
        ...
        hint: "Daemon keeps running when you quit Paseo Reforged",
      },
      logs: {
        title: "Log file",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Paseo Reforged CLI.",
      },
    },
  },
  rootError: {
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Paseo Reforged server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Paseo Reforged relay works",
      ...
      updateRequired: "Update the host to enable relay from Paseo Reforged Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Paseo Reforged on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Paseo Reforged {{count}} time",
      other: "called Paseo Reforged {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Paseo Reforged handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Paseo Reforged uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Paseo Reforged picks a fast available model",
      preferredHint: "Choose the model Paseo Reforged uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Paseo Reforged falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Paseo Reforged.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Paseo Reforged on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Paseo Reforged skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Paseo Reforged skills?",
        uninstallMessage:
          "Removes all Paseo Reforged orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable Paseo Reforged tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject Paseo Reforged tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Paseo Reforged reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Paseo Reforged reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Paseo Reforged supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Paseo Reforged uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
