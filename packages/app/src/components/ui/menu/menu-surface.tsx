...
export interface MenuSurfaceProps {
  ...
  scrollable?: boolean;
  /** Lets an open web context menu close while the same gesture opens another row's menu. */
  ...
  return (
    <MenuSurfaceContext.Provider value={surfaceValue}>
      <MenuOverlay
        visible={menu.open}
        onClose={handleClose}
        allowWebContextMenuPassthrough={allowWebContextMenuPassthrough}
      >
        <>
          <AnchoredSurface
            open={menu.open}
            ...
            backdrop={!isWeb || !allowWebContextMenuPassthrough}
            testID={testID}
          >
