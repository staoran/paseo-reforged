...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/staoran/paseo-reforged/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Paseo-Reforged-${normalizedVersion}-arm64.dmg`;
}
