...
function resolveWorktreeSupport(
  project: HostProjectListItem | null,
  serverId: string,
): ReturnType<typeof getWorktreeSupportForHostProject> {
  if (!project) {
    return "unsupported";
  }
...
export function NewWorkspaceScreen({
  ...
  const worktreeSupport = resolveWorktreeSupport(selectedProject, selectedServerId);
