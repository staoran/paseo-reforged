...
describe("keyboard-shortcuts", () => {
  const matchingCases: MatchingShortcutCase[] = [
    ...
    {
      name: "matches Cmd+P to search workspace files while the message input is focused on mac",
      event: { key: "p", code: "KeyP", metaKey: true },
    ...
    {
      name: "matches Ctrl+P to search workspace files while the message input is focused on non-mac",
      event: { key: "p", code: "KeyP", ctrlKey: true },
  ...
  const nonMatchingCases: NonMatchingShortcutCase[] = [
    ...
    {
      name: "does not switch project with Cmd+P on mac while terminal is focused",
      event: { key: "p", code: "KeyP", metaKey: true },
      context: { isMac: true, focusScope: "terminal" },
    },
    {
      name: "does not switch project while an editable control is focused",
      event: { key: "p", code: "KeyP", ctrlKey: true },
      context: { isMac: false, focusScope: "editable" },
    },
    {
      name: "does not switch project from an aria-modal sheet",
      event: { key: "p", code: "KeyP", metaKey: true },
      context: { isMac: true, focusScope: "modal" },
    },
    {
