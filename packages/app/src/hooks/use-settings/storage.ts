...
// COMPAT(workspaceTypographySettings): these aliases keep older app imports source-compatible.
export const DEFAULT_UI_FONT_SIZE = DEFAULT_UI_BASE_FONT_SIZE;
export const MIN_UI_FONT_SIZE = MIN_UI_BASE_FONT_SIZE;
export const MAX_UI_FONT_SIZE = MAX_UI_BASE_FONT_SIZE;
export const DEFAULT_WORKSPACE_FONT_SIZE = 16;
...
const StoredAppSettingsSchema = z
  .looseObject({
    ...
    workspaceFontFamily: sanitizedFontFamily().catch(""),
    ...
    workspaceFontSize: clampedNumber(MIN_WORKSPACE_FONT_SIZE, MAX_WORKSPACE_FONT_SIZE).catch(
