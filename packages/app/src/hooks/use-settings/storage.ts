...
const StoredAppSettingsSchema = z.strictObject({
  ...
  restoreLastWorkspaceOnLaunch: z.boolean().optional(),
  ...
  workspaceFontFamily: z.string().optional(),
  monoFontFamily: z.string().optional(),
  uiFontSize: z.union([z.number(), z.string()]).optional(),
  workspaceFontSize: z.union([z.number(), z.string()]).optional(),
  ...
  autoExpandActivity: z.boolean().optional(),
