...
export const Route = createFileRoute("/hub")({
  head: () =>
    pageMeta(
      "Upstream Paseo Hub - GitHub, Slack, and Discord triggers",
      "An optional service maintained by upstream Paseo, not operated or released by Paseo Reforged. It adds GitHub, Slack, and Discord triggers above compatible daemons.",
      "/hub",
    ),
  component: Hub,
});
...
function Hub() {
  return (
    <SiteShell width="default">
      <h1 className="text-3xl font-medium tracking-tight mb-4">Upstream Paseo Hub</h1>
      ...
      <p className="mt-6 max-w-2xl rounded-lg border border-white/10 bg-white/[0.03] px-4 py-3 text-sm text-white/60">
        Hub is maintained by the{" "}
        <a
        ...
        >
          upstream Paseo project
        </a>
        . It is not a Paseo Reforged release or hosted service.
      </p>
