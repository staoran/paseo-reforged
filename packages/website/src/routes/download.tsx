...
export const Route = createFileRoute("/download")({
  ...
  head: () =>
    pageMeta(
      "Download Paseo Reforged for macOS, Windows, Linux, and Android",
      "Install Paseo Reforged desktop apps for macOS, Windows, and Linux, or the Android APK. Self-hosted, open source, and free to download.",
      "/download",
    ),
  component: Download,
});
      ...
      <section className="rounded-xl border border-border bg-card/40 p-6 md:p-8">
        <div className="flex items-start justify-between mb-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Run the Paseo Reforged server anywhere, connect from any client
            </p>
          </div>
        ...
        <div className="divide-y divide-border">
          <PlatformRow icon={TerminalIcon} label="Nix">
            <CodeBlock size="sm">
              {onBeta
                ? `nix run github:staoran/paseo-reforged/v${version}`
