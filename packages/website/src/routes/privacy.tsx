...
export const Route = createFileRoute("/privacy")({
  head: () =>
    pageMeta(
      ...
      "What stays on your machines, what optional relay services can see, and what upstream Hub stores.",
      "/privacy",
    ),
  component: Privacy,
});
  ...
  return (
    <LegalPage title="Privacy Policy" lastUpdated="August 29, 2026">
      ...
      <section>
        ...
        <p>
          Paseo Reforged is an independently maintained, self-hosted tool for managing coding
          agents. Your local daemon, apps, and data are controlled by you or the operator who hosts
          them. The official Paseo website, relay, and hosted Hub referenced below are operated by
          their respective service operators; independently self-hosted daemons, Hubs, and relays
          are controlled by their operators and are not covered by this policy.
        </p>
      </section>

      <section>
        <h2>Local Paseo Reforged apps and daemons</h2>
        <p>
          Paseo Reforged runs on your machines. It does not send us analytics, telemetry,
      ...
      <section>
        <h2>Service providers for optional official services</h2>
        <p>
          The upstream official services use Fly.io for hosted infrastructure, Stripe for
          subscriptions and payments, and GitHub for software releases and connected GitHub
          features. Slack, Discord, Linear, and other services receive data only when you choose to
          connect or use them.
        </p>
        <p>
