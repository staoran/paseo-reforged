...
export class Session {
  ...
  // oxlint-disable-next-line complexity -- Dispatch keeps all inbound message variants in one owner
  ...
  private dispatchAgentLifecycleMessage(msg: SessionInboundMessage): Promise<void> | undefined {
    switch (msg.type) {
      ...
      default:
        return this.dispatchAgentInteractionMessage(msg);
    }
  }

  private dispatchAgentInteractionMessage(msg: SessionInboundMessage): Promise<void> | undefined {
    switch (msg.type) {
