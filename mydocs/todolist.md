...
| 0082 | 待手工验收 | micro-spec | 已同步        | [修复 Windows 升级安装后启动](micro_specs/0082_修复Windows升级安装后启动.md)                               | 2026-08-18 00:59 | `--updated` exact-match 修复与 `12/12` 回归、Desktop typecheck、lint、格式均通过；待真实覆盖升级验收                                                           |
