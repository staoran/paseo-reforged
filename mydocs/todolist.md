...
| 0104 | 执行中     | micro-spec | 已同步        | [Android release source map 优化](micro_specs/0104_Android release source map优化.md)                      | 2026-09-11       | beta5 EAS 云构建因 profile 漏传 ABI 产出四架构并被校验拒绝；已补 arm64 配置与回归测试，待发布 beta.6 验证 APK                                    |
