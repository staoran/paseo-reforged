...
| 0057 | 待提交 | micro-spec | 已同步        | [修复 stable 合并后 Playwright 合同](micro_specs/0057_修复stable合并后Playwright合同.md)          | 2026-08-09       | C01-C09 与四个额外 Windows/stable 合同已修正；定向单测、Playwright `59/59`、静态检查与格式化通过，待提交并推送 main     |
