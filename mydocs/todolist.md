...
| 0069 | 执行中     | micro-spec | 已落盘        | [稳定 Android Gradle cache key](micro_specs/0069_稳定Android_Gradle_cache_key.md)                 | 2026-08-15       | 移除 run-specific 主键，连续同内容运行只保存一次约 2.17 GB cache                                                                      |
