...
| 0066 | 待手工验收 | micro-spec | 已同步        | [控制启动时恢复上次工作区](micro_specs/0066_控制启动时恢复上次工作区.md)                          | 2026-08-14 14:21 | 四个 TDD 切片与 108 个目标测试、typecheck、lint、format 通过；用户要求独立提交并排除 0065/dev.ps1，待真实客户端两态冒烟                         |
...
| 0068 | 执行中     | micro-spec | 已同步        | [观测 Android 冷构建资源峰值](micro_specs/0068_观测Android冷构建资源峰值.md)                      | 2026-08-15 13:27 | 切片 1 baseline、切片 2 Gradle cache seed/hit 已完成（runs `31862057595`、`31864116282`、`31866295866`）；切片 3-4 待批准                       |
