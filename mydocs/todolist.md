...
| 0063 | 已收口     | micro-spec | Review 完成   | [修复标题栏边界拖拽死带](micro_specs/0063_修复标题栏边界拖拽死带.md)                                       | 2026-08-19       | 菜单竞态 Red→Green：34/10,262 次失效降至 0/5,292；开关稳态与 Electron 回归通过                                                                                                            |
...
| 0082 | 已收口     | micro-spec | 已同步        | [修复 Windows 升级安装后启动](micro_specs/0082_修复Windows升级安装后启动.md)                               | 2026-08-28 23:05 | `--updated` 回归与 Desktop typecheck/lint 通过；Windows x64 NSIS 构建、隔离覆盖升级、GUI/CDP relaunch 和 packaged smoke 通过；签名包完成页待验收                                          |
| 0083 | 已收口     | micro-spec | 已同步        | [状态分组未读完成态提示](micro_specs/0083_状态分组未读完成态提示.md)                                       | 2026-08-18 10:25 | 状态分组 Ready 行未读为 600+绿点、已读为 400+无点；核心 Vitest 60/60、fixture 40/40、Playwright、typecheck、lint 与格式通过                                                               |
| 0084 | 进行中     | spec       | 已同步        | [跨端中继二进制加密与状态追平压缩](specs/0084_跨端中继二进制加密与状态追平压缩.md)                         | 2026-09-02       | review-fix `c9fb23701` 已提交；production framed gate 已关闭并保持 legacy wire；Hermes 真机阻塞、hosted near-limit 两种表示均 `1009`                                                      |
...
| 0087 | 已收口     | micro-spec | 已同步        | [Daemon framed selection 与 pending confirm](micro_specs/0087_daemon_framed_selection与pending_confirm.md) | 2026-08-19       | 28 个 scoped 用例全绿；legacy 15/15、crypto 8/8、server relay 6/6、typecheck/lint/format/diff 通过                                                                                        |
| 0088 | 已收口     | micro-spec | 已同步        | [Framed envelope 与解码安全](micro_specs/0088_framed_envelope与解码安全.md)                                | 2026-08-19       | 公共 envelope/parser、严格 Base64/wire、UTF-8、长度、收益、ratio 与 bounded inflate 门禁已 GREEN                                                                                          |
| 0089 | 已收口     | micro-spec | 已同步        | [Daemon 压缩准备与 codec 门禁](micro_specs/0089_daemon压缩准备与codec门禁.md)                              | 2026-08-19       | Node raw DEFLATE、固定 level 1、class/size/gain/ratio/双槽门禁与 prepared payload 已 GREEN                                                                                                |
| 0090 | 已收口     | micro-spec | 已同步        | [加密帧 FIFO 与高水位](micro_specs/0090_加密帧FIFO与高水位.md)                                             | 2026-08-19       | opening/receive/send FIFO、32/64 MiB reservation、exact wire 高水位与失败释放已 GREEN                                                                                                     |
| 0091 | 已收口     | micro-spec | 已同步        | [Relay transport policy 运行时接入](micro_specs/0091_relay_transport_policy运行时接入.md)                  | 2026-08-20       | configured/negotiated/effective 单点 resolver、compression 热更新和新连接 encoding 锁定已 GREEN                                                                                           |
| 0092 | 已收口     | micro-spec | 已同步        | [业务流量分类与 terminal/file hint](micro_specs/0092_业务流量分类与terminal_file_hint.md)                  | 2026-08-20       | realtime/state-sync/bulk/bulk-live、16 KiB completed tool-call 与 terminal/file hint 已 GREEN                                                                                             |
| 0093 | 已收口     | micro-spec | 已同步        | [Client fflate 解码与兼容](micro_specs/0093_client_fflate解码与兼容.md)                                    | 2026-08-19       | fflate bounded raw inflate、Node 跨实现 vectors、client 出站 identity 与旧端兼容已 GREEN                                                                                                  |
| 0094 | 已收口     | micro-spec | 已同步        | [Desktop 中继传输配置](micro_specs/0094_Desktop中继传输配置.md)                                            | 2026-08-20       | capability-gated encoding/压缩开关、最小 patch 与 RPC 成功/失败回填已 GREEN；不暴露 algorithm/strategy/level                                                                              |
| 0095 | 已收口     | micro-spec | 已同步        | [中继压缩指标与 benchmark](micro_specs/0095_中继压缩指标与benchmark.md)                                    | 2026-08-20       | server/client 无内容指标与真实 JSON/terminal/file/tool-call level 1/3/6 benchmark 已 GREEN                                                                                                |
...
| 0097 | 待手工验收 | micro-spec | 已同步        | [混合版本真实环境与文档收口](micro_specs/0097_混合版本真实环境与文档收口.md)                               | 2026-09-02       | Desktop/realtime validation PASS；production framed gate 已关闭；Hermes CLI FAIL/真机阻塞，hosted near-limit Base64/binary FAIL (`1009`)                                                  |
...
| 0101 | 已收口     | micro-spec | 已同步        | [会话 Token 费用与使用情况降噪](micro_specs/0101_会话Token费用与使用情况降噪.md)                           | 2026-09-02       | `6004fb55b`；Vitest 11/11、两条 Browser E2E、typecheck/lint/format/diff 通过；权威 token/cost 与 available-only provider 展示已收口                                                       |
...
| 0104 | 已收口     | micro-spec | 已同步        | [Android release source map 优化](micro_specs/0104_Android release source map优化.md)                      | 2026-09-11       | `v0.7.2-beta.6` EAS 云构建成功，runner fallback 跳过；APK v2 签名、`sh.paseo.reforged` 与 arm64-only 校验均通过，三条 tag workflow 全绿                                                   |
...
| 0110 | 验证中     | micro-spec | 已同步        | [修复主分支 CI 红项](micro_specs/0110_修复主分支CI红项.md)                                                 | 2026-09-12       | 定向回归与静态门禁已绿；完整 CI 待验                                                                                                                                                      |
...
| Spec 0085          | 维护 | fake App Server 的 `waitForTurnStart()` 重复消费历史首条 `turn/start`，可使连续第二轮 `session.run()` 不 settle | 独立修复消息消费语义，并覆盖重复等待与 compaction/retry 流程    |
