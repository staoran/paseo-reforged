...
| 0058 | 待验证 | micro-spec | 已同步        | [修复 beta.5 Android APK 版本校验合同](micro_specs/0058_修复beta5AndroidAPK版本校验合同.md)       | 2026-08-09       | 本地 Red/Green、lint、typecheck 已通过；待推送修复并用不可变 `v0.3.0-beta.5` tag 重跑 Android workflow                  |
