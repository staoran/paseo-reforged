...
| 0084 | 进行中     | spec       | 已同步        | [跨端中继二进制加密与状态追平压缩](specs/0084_跨端中继二进制加密与状态追平压缩.md)                         | 2026-08-27       | 0087–0097 已逐票实施；hosted relay `3/3`、弱网两档与统一代码审查通过；Hermes、Desktop packaged smoke、realtime p95 和 hosted relay 近 32 MiB 边界仍阻塞        |
...
| 0097 | 待手工验收 | micro-spec | 已同步        | [混合版本真实环境与文档收口](micro_specs/0097_混合版本真实环境与文档收口.md)                               | 2026-08-27       | live relay `3/3`、2 Mbps/150 ms 与 10 Mbps/80 ms 弱网矩阵和统一代码审查通过；Hermes、Desktop packaged smoke、realtime p95 与 hosted relay 近 32 MiB 边界待完成 |
