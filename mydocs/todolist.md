...
| 0057 | 待提交 | micro-spec | 已同步        | [修复 stable 合并后 Playwright 合同](micro_specs/0057_修复stable合并后Playwright合同.md)          | 2026-08-09       | CI run `31304387729` 唯一失败已定位为 C03 普通流旧文案断言；修正后本地单用例 `1/1` 通过，待追加提交                     |
