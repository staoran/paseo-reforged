...
| 0084 | 进行中     | spec       | 已同步        | [跨端中继二进制加密与状态追平压缩](specs/0084_跨端中继二进制加密与状态追平压缩.md)                         | 2026-08-20       | 0087–0095 已逐票收口；真实 JSON level 1 binary wire 为 legacy 的 `19.03%`；下一单元 0097 环境验收与统一审查                                     |
...
| 0097 | 执行中     | micro-spec | 已同步        | [混合版本真实环境与文档收口](micro_specs/0097_混合版本真实环境与文档收口.md)                               | 2026-08-20       | 前置 0087–0095 已满足；当前执行 mixed-version、live relay、弱网/Hermes 可用环境审计、长期文档与统一代码审查                                     |
